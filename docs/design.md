...
3. **Timer and examiner, always.** Every test has a timer that fails you at zero and an examiner who deducts minor faults, fails serious ones instantly, and comments. The timer makes you hurry; the examiner punishes hurrying. Both are present in every test.
4. **Shared fate.** Exactly three players, one license, one result. See ADR-0001.
