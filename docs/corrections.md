...
- 2026-09-14 | sight | Three-human playtest required dismounting to see ahead on nearly every move, preventing improvement; explore a shared elevated third-person truck view after seating, with readable destinations and completion conditions.
- 2026-09-14 | split | Playtest laughter faded, control complexity felt uneven, and roles felt unequally important; reopen the split between shared driving and one driver with other active responsibilities rather than treating either as decided.
- 2026-09-14 | other | Remove the rear staircase and give the truck a recognisable monster-truck silhouette rather than a safari-car appearance; proposed boarding is hold Space while moving against the truck to climb, highlight a targeted seat, and press E to enter.
- 2026-09-14 | controls | Three-human playtest found front steering satisfying, gas/brake unintuitive and unpleasant, and rear steering the least necessary role; preserve the useful front-steering feel while reconsidering pedal interaction and whether rear steering deserves a player role.
- 2026-09-14 | controls | Core driving and role interactions must be approachable for younger and less mechanical players, with understandable responses and recoverable mistakes; difficulty should come from shared situations rather than making basic operation feel beyond a player's ability.
- 2026-09-14 | split | For the next monster-truck revision, pursue three simple, active contributions to operating the truck; exact responsibilities remain undecided, and the current rear-steering role is not retained by default.
- 2026-09-14 | sight | For the next revision, all seated players share an elevated third-person truck camera with readable road, destinations, hazards, and accidents; this supersedes the earlier restriction to physical-position sight for seated monster-truck play.
- 2026-09-14 | scoring | Beginner groups should usually recover and reach the end, with a pass realistically achievable despite ordinary mistakes; cleaner performance can take practice, and exact failure conditions remain to be revised.
- 2026-09-14 | split | Explore steering / speed / balance as the next monster-truck role-split candidate, allowing exaggerated weight-shifting actions; balance must contribute during ordinary driving without constant rollover prevention, and the split still requires playtest validation.
- 2026-09-14 | scoring | Cone hits, repeated parking attempts, and a recovered rollover may lower the rating but still allow a pass after completing the required manoeuvres; supersede automatic rollover failure, keep immediate failure rare, and give beginners generous time for learning and recovery.
- 2026-09-14 | controls | Balance candidate uses directional weight shifting with a clear exaggerated truck response: lean into corners and shift forward/backward over bumps; easy ground remains manageable without balancing, and regular enjoyable participation must be established by playtest.
- 2026-09-14 | controls | Speed role uses hold W for forward acceleration and hold S to brake then reverse after stopping; releasing both slows gently, with no separate direction selection or parking-brake management during ordinary driving.
- 2026-09-14 | controls | After an overturned truck settles, any player can use a clearly prompted hold-to-right action that restores it upright nearby and adds a fault while allowing the test to continue; this supersedes the earlier prohibition on recovery assistance.
- 2026-09-14 | ui | All players see a short current manoeuvre instruction, its destination or target area, its passing requirement before attempting it, and clear completion feedback; examiner speech is not the sole source of test guidance.
- 2026-09-14 | scope | Next revision is a short fully completable test in the existing scrapyard with a turn, forgiving bumps, and a parking finish; include shared camera, revised boarding, steering/speed/balance, recovery, generous timer, and actual pass/results before expanding the full route, contingent on three-role enjoyment in playtest.
- 2026-09-14 | controls | Seated learners remain attached through bumps, crashes, and rollovers until deliberately exiting; climbing is for boarding rather than repeated involuntary rescue, superseding earlier ejection behavior for seated learners.
- 2026-09-14 | scoring | The short revised test avoids workers in the driving path and an accessible ravine; leaving the course offers nearby recovery with a fault. Completing all three manoeuvres before the generous timer expires passes, with faults affecting rating only; dangerous encounters remain deferred for route expansion.
- 2026-09-14 | split | Choose physical seats when boarding, and allow a simple role/seat-swap request while the truck is stopped that the other player accepts; deliberate exit remains available without requiring reboarding for every role rotation.
- 2026-09-14 | other | Later learner presentation should feel cuter and more approachable through softer, simpler character designs and friendlier movement/animation; keep this visual direction outside the next playable revision.

- 2026-09-14 | workflow | Finish the approved revised gameplay code first, then hand truck 3D-model work to Astra; integrate and verify that art before preparing the final playtest packages.

- 2026-09-14 | vehicle | Use Hot Wheels-style monster-truck proportions: a much smaller body, very large wheels, and visibly high suspension/body clearance.
